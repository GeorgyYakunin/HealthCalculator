...
public class ActivityBloodDonatRes extends AppCompatActivity {
    Animation rotate;
    TextView tvEdd;
    TextView tvEddDesc;
    TextView tvEddVal;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.act_blood_donate_res);
//
        init();
...
//            }
//        });
//        setTitle(getResources().getString(R.string.act_blood_donate));
