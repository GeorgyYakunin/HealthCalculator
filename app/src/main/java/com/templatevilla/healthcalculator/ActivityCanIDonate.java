...
public class ActivityCanIDonate extends AppCompatActivity {
    TextView tv1;
    Toolbar toolbar;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.act_blood_vol_can_i_donate);
        init();

//
        findViewById(R.id.chart).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ActivityCanIDonate.this.startActivity(new Intent(ActivityCanIDonate.this, ActivityChartBloodVolume.class));
            }
        });
    }
