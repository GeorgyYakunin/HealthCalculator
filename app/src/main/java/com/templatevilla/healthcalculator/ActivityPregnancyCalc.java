...
public class ActivityPregnancyCalc extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.act_pregnancy);

        findViewById(R.id.chart).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ActivityPregnancyCalc.this.startActivity(new Intent(ActivityPregnancyCalc.this, ActivityChartPreg.class));
            }
        });
        ...
        pdf.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                try {
                    ...
                    PDFView.with(ActivityPregnancyCalc.this).setfilepath(file.getAbsolutePath())
        ...
        final OnDateSetListener r6 = new OnDateSetListener() {
            public void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                ...
                switch (Integer.parseInt(split[0])) {
                    case 1:
                        TextView textView = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.jan) +
                                str +
                                split[2];
                        textView.setText(sb);
                        break;
                    case 2:
                        TextView textView2 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb2 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.feb) +
                                str +
                                split[2];
                        textView2.setText(sb2);
                        break;
                    case 3:
                        TextView textView3 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb3 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.mar) +
                                str +
                                split[2];
                        textView3.setText(sb3);
                        break;
                    case 4:
                        TextView textView4 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb4 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.apr) +
                                str +
                                split[2];
                        textView4.setText(sb4);
                        break;
                    case 5:
                        TextView textView5 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb5 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.may) +
                                str +
                                split[2];
                        textView5.setText(sb5);
                        break;
                    case 6:
                        TextView textView6 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb6 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.jun) +
                                str +
                                split[2];
                        textView6.setText(sb6);
                        break;
                    case 7:
                        TextView textView7 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb7 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.jul) +
                                str +
                                split[2];
                        textView7.setText(sb7);
                        break;
                    case 8:
                        TextView textView8 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb8 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.aug) +
                                str +
                                split[2];
                        textView8.setText(sb8);
                        break;
                    case 9:
                        TextView textView9 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb9 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.sep) +
                                str +
                                split[2];
                        textView9.setText(sb9);
                        break;
                    case 10:
                        TextView textView10 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb10 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.oct) +
                                str +
                                split[2];
                        textView10.setText(sb10);
                        break;
                    case 11:
                        TextView textView11 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb11 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.nov) +
                                str +
                                split[2];
                        textView11.setText(sb11);
                        break;
                    case 12:
                        TextView textView12 = ActivityPregnancyCalc.this.tvdatechosenval;
                        String sb12 = split[1] +
                                str +
                                ActivityPregnancyCalc.this.getResources().getString(R.string.dec) +
                                str +
                                split[2];
                        textView12.setText(sb12);
                        break;
        ...
        OnClickListener r0 = new OnClickListener() {
            public void onClick(View view) {
                ActivityPregnancyCalc.this.anInt++;
                instance.set(i4, i5, i6);
                DatePickerDialog datePickerDialog = new DatePickerDialog(ActivityPregnancyCalc.this, r6, instance.get(Calendar.YEAR), instance.get(Calendar.MONTH), instance.get(Calendar.DATE));
        ...
        OnClickListener r02 = new OnClickListener() {
            public void onClick(View view) {
                int i = ActivityPregnancyCalc.this.anInt;
                String str = "";
                ...
                if (i == 0) {
                    ...
                    Intent intent = new Intent(ActivityPregnancyCalc.this, ActivityPregnancyCalcRes.class);
                    intent.putExtra(str, format);
                    ActivityPregnancyCalc.this.startActivity(intent);
                    return;
                }
                String format2 = new SimpleDateFormat(str2, Locale.US).format(instance.getTime());
                Intent intent2 = new Intent(ActivityPregnancyCalc.this, ActivityPregnancyCalcRes.class);
                intent2.putExtra(str, format2);
                ActivityPregnancyCalc.this.startActivity(intent2);
            }
        };
